    ...
    myIdeas.forEach(idea => {
                ...
                <div class="user-card-feed-item">
                    <article class="card-collection-item">
                        <div class="card-collection-item-content">
                            <a href="/idea/detail?id=${idea.id}" class="card-collection-item-content-link"></a>
                            <div class="card-item-description card-collection-item-description">
                                <div class="card-item-description-content">${idea.ideaTitle}</div>    <!--아이디어 제목-->
                            </div>
        ...
        idea.files.forEach(file => {
            if (file.ideaFileType == "REPRESENTATIVE") {
                textRow += `<img src="/idea-files/display?fileName=${file.ideaFilePath}/t_${file.ideaFileUuid}_${file.ideaFileName}" class="image">`;
            }
        });
